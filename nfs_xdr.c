...
xdr_renameargs (XDR *xdrs, renameargs *objp)
{
	register int32_t *buf;
	 ...
	 if (!xdr_diropargs (xdrs, &objp->src))
		 return FALSE;
	 if (!xdr_diropargs (xdrs, &objp->dest))
		 return FALSE;
	return TRUE;
}
...
xdr_RENAME3args (XDR *xdrs, RENAME3args *objp)
{
	register int32_t *buf;
	 ...
	 if (!xdr_diropargs3 (xdrs, &objp->src))
		 return FALSE;
	 if (!xdr_diropargs3 (xdrs, &objp->dest))
		 return FALSE;
	return TRUE;
}
